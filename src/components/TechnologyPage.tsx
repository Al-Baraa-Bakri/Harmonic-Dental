import { ArrowLeft, Sparkles, Play, ScanFace, Camera, Cpu, Scan, Printer, Palette, type LucideIcon } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Badge } from "@/components/ui/badge";
import type { ProcessedTechnologyItem, ProcessedTechnologyPage } from "@/lib/api/technology-page";
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <span className="text-sm text-foreground/90">Innovation & Precision</span>
            </div>
        ...
        <div className="container mx-auto px-6">
          {technologyItems.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-semibold mb-2">No Technologies Yet</h3>
              ...
              {technologyItems.map((item: any, index: any) => {
                ...
                return (
                  <div
                    ...
                    style={{ animation: `fade-in 0.6s ease-out ${animationDelay}s both` }}
                  >
                    {/* Outer Glow Effect */}
                    <div className="absolute -inset-1 bg-gradient-to-r from-primary/50 via-accent/50 to-primary/50 rounded-2xl opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-500" />
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-8">
              Discover how our advanced technology can transform your dental solutions.
            </p>
